	...
	<div class="public-row title layer{layer}">
		...
		<div class="sum-lesson sum">
			{#if !(subject.global.n_visit>0 && subject.global.visit)}
				...
				{:else}
					<div class="sumpart {bool2noprint(subject.global.n_watch && subject.global.show)}"></div>
					<div class="sumpart {bool2noprint(subject.global.n_watch && subject.global.show)}">{subject.global.n_watch} <img class="icon" src={watch} alt=""/> </div>
				{/if}
			{:else}
				<div class="sumpart {bool2noprint(subject.global.n_visit && subject.global.show)}">{subject.global.n_visit}<img class="icon" src={visit} alt=""/> </div>
				<div class="sumpart {bool2noprint(subject.global.n_watch && subject.global.show)}">{subject.global.n_watch} <img class="icon" src={watch} alt=""/> </div>
			{/if}
		</div>
